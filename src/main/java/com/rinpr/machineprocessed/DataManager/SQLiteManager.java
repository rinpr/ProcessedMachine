...
public class SQLiteManager {
    ...
    public SQLiteManager(MachineProcessed plugin) {
        this.dbFile = "jdbc:sqlite:" + plugin.getDataFolder().getAbsolutePath() + File.separator + "machine.db";
        loadSQLite();
        createTables();
    }
    private void createTables(){
        try { connection.prepareStatement(createTable).execute();
